...
export default function Page({ page, breadcrumbs }) {
  const { title, metaTitle, description, slug, content, featuredImage, children, acf } = page;
  ...
  const hasFlexibleFields = Array.isArray(acf.flexibleFields) && acf.flexibleFields.length > 0;
      ...
      <Content>
        <Section>
          <Container>
            ...
            {/* return normal html content as for normal WordPress page */}
            <div
